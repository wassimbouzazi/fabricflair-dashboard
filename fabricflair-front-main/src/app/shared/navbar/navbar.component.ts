...
export class NavbarComponent implements OnInit {
  ...
  ngOnInit() {
    this.user_type = jwt_decode(localStorage.getItem("access_token")).type;

    this.email_type =
      jwt_decode(localStorage.getItem("access_token")).email +
      " (" +
      jwt_decode(localStorage.getItem("access_token")).type +
      ")  ";
  ...
  onSearchClicked(): void {
    this.search.changeMessage(this.searchValue);
  }
